  ...
  resources: {
    en: {
      translation: {
        ...
        order_successful_message: "Order created successfully!",
        order_failed_message: "Failed to create order. Please try again.",
        orderPage: {
          title: "Order List",
    ...
    vi: {
      translation: {
        hello: "Xin chào",
        order_successful_message: "Tạo đơn hàng thành công",
        order_failed_message: "Tạo đơn hàng thất bại. Vui lòng thử lại.",
        product: {
